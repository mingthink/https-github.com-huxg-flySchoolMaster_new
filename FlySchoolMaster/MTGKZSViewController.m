...
- (void)viewDidLoad
{
    ...
    [FuncPublic InstanceNavgationBar:@"高考招生" action:@selector(btnlcik:) superclass:self isroot:NO];
...
-(void)loaddata
{
    ...
    //    if([FuncPublic GetDefaultInfo:@"zxdm"])
    //    {
    //        [dic setObject:@"" forKey:@"zxdm"];
    //        [FuncPublic SaveDefaultInfo:dic Key:@"zxdm"];
    //    }
    //    else
    //    {
