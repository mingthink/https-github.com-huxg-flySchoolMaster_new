...
-(void)viewWillAppear:(BOOL)animated
{
   ...
   // float sizek = [self getCacheSizeandclear:NO];
   // [self.caheBnt setTitle:[NSString stringWithFormat:@"清除缓存 %2.fk",sizek] forState:UIControlStateNormal];
}
- (void)viewDidLoad
{
    [super viewDidLoad];
...
//    [self.caheBnt setTitle:@"无残留" forState:UIControlStateNormal];
